...
(id, username, password, nickname, email, is_admin, is_staff, is_active, salt, is_deleted)
VALUES
(1, "admin", "eda88570dad35bc024dfd5ab8ac23e56", "Admin", "admin@example.com", 1, 1, 1, "12345678", 0),
(2, "guest", "b4258ca8ea34375760bd99375e75128e", "Guest", "guest@example"    , 0, 1, 1, "12345678", 0);
